...
import service.interfaz.IUserService;
...
public class UserService implements IUserService {
    ...
    private void enviarEmailRecuperacion(User usuario, String token) {
        String linkRecuperacion = "http://localhost:3000/reset-password?token=" + token;

        SimpleMailMessage mensaje = new SimpleMailMessage();
        mensaje.setFrom("jeremyangeles495@gmail.com");
        mensaje.setTo(usuario.getEmail());
        mensaje.setSubject("Recuperación de Contraseña - BookTrack");
